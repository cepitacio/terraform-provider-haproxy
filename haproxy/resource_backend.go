			...
			"default_server": schema.SingleNestedBlock{
				...
				Attributes: map[string]schema.Attribute{
					...
					"sslv3": schema.StringAttribute{
						Optional:    true,
						Description: "SSLv3 support for the default server.",
					},
					"tlsv10": schema.StringAttribute{
						Optional:    true,
						Description: "TLSv1.0 support for the default server.",
					},
					"tlsv11": schema.StringAttribute{
						Optional:    true,
						Description: "TLSv1.1 support for the default server.",
					},
					"tlsv12": schema.StringAttribute{
						Optional:    true,
						Description: "TLSv1.2 support for the default server.",
					},
					"tlsv13": schema.StringAttribute{
						Optional:    true,
						Description: "TLSv1.3 support for the default server.",
					},
					"no_sslv3": schema.StringAttribute{
						Optional:    true,
						Description: "Disable SSLv3 for the default server.",
					},
					"no_tlsv10": schema.StringAttribute{
						Optional:    true,
						Description: "Disable TLSv1.0 for the default server.",
					},
					"no_tlsv11": schema.StringAttribute{
						Optional:    true,
						Description: "Disable TLSv1.1 for the default server.",
					},
					"no_tlsv12": schema.StringAttribute{
						Optional:    true,
						Description: "Disable TLSv1.2 for the default server.",
					},
					"no_tlsv13": schema.StringAttribute{
						Optional:    true,
						Description: "Disable TLSv1.3 for the default server.",
					},
					"force_sslv3": schema.StringAttribute{
						Optional:    true,
						Description: "Force SSLv3 for the default server.",
					},
					"force_tlsv10": schema.StringAttribute{
						Optional:    true,
						Description: "Force TLSv1.0 for the default server.",
					},
					"force_tlsv11": schema.StringAttribute{
						Optional:    true,
						Description: "Force TLSv1.1 for the default server.",
					},
					"force_tlsv12": schema.StringAttribute{
						Optional:    true,
						Description: "Force TLSv1.2 for the default server.",
					},
					"force_tlsv13": schema.StringAttribute{
						Optional:    true,
						Description: "Force TLSv1.3 for the default server.",
					},
					"force_strict_sni": schema.StringAttribute{
						Optional:    true,
						Description: "Force strict SNI for the default server.",
					},
				},
			},
