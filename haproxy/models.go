...
type HttpRequestRulePayload struct {
	...
	TrackScID            int64       `json:"track_sc_id,omitempty"`
	TrackScIdx           int64       `json:"track_sc_idx,omitempty"`
	TrackScInt           int64       `json:"track_sc_int,omitempty"`
	...
	ScAddGpc             string      `json:"sc_add_gpc,omitempty"`
	...
	ScSetGpt             string      `json:"sc_set_gpt,omitempty"`
	ScSetGpt0            string      `json:"sc_set_gpt0,omitempty"`
	SetPriorityClass     string      `json:"set_priority_class,omitempty"`
	SetPriorityOffset    string      `json:"set_priority_offset,omitempty"`
	SetRetries           string      `json:"set_retries,omitempty"`
	SetBcMark            string      `json:"set_bc_mark,omitempty"`
	SetBcTos             string      `json:"set_bc_tos,omitempty"`
	SetFcMark            string      `json:"set_fc_mark,omitempty"`
	SetFcTos             string      `json:"set_fc_tos,omitempty"`
	SetDst               string      `json:"set_dst,omitempty"`
	SetDstPort           int64       `json:"set_dst_port,omitempty"`
	SetSrc               string      `json:"set_src,omitempty"`
	SetSrcPort           int64       `json:"set_src_port,omitempty"`
	SetTimeout           string      `json:"set_timeout,omitempty"`
	SetTos               string      `json:"set_tos,omitempty"`
	SetMark              string      `json:"set_mark,omitempty"`
	SetVar               string      `json:"set_var,omitempty"`
	SetVarFmt            string      `json:"set_var_fmt,omitempty"`
	UnsetVar             string      `json:"unset_var,omitempty"`
	EarlyHint            string      `json:"early_hint,omitempty"`
	UseService           string      `json:"use_service,omitempty"`
	WaitForBody          string      `json:"wait_for_body,omitempty"`
	WaitForHandshake     string      `json:"wait_for_handshake,omitempty"`
	SilentDrop           string      `json:"silent_drop,omitempty"`
	Tarpit               string      `json:"tarpit,omitempty"`
	DisableL7Retry       string      `json:"disable_l7_retry,omitempty"`
	DoResolve            string      `json:"do_resolve,omitempty"`
	SendSpoeGroup        string      `json:"send_spoe_group,omitempty"`
	ReplaceHeader        string      `json:"replace_header,omitempty"`
	ReplacePath          string      `json:"replace_path,omitempty"`
	ReplacePathq         string      `json:"replace_pathq,omitempty"`
	ReplaceUri           string      `json:"replace_uri,omitempty"`
	ReplaceValue         string      `json:"replace_value,omitempty"`
	AddHeader            string      `json:"add_header,omitempty"`
	DelHeader            string      `json:"del_header,omitempty"`
	AddAcl               string      `json:"add_acl,omitempty"`
	DelAcl               string      `json:"del_acl,omitempty"`
	SetMap               string      `json:"set_map,omitempty"`
	DelMap               string      `json:"del_map,omitempty"`
	CacheUse             string      `json:"cache_use,omitempty"`
	...
	NormalizeUri         string      `json:"normalize_uri,omitempty"`
	SetMethod            string      `json:"set_method,omitempty"`
	SetQuery             string      `json:"set_query,omitempty"`
	SetUri               string      `json:"set_uri,omitempty"`
	SetLogLevel          string      `json:"set_log_level,omitempty"`
	SetBandwidthLimit    string      `json:"set_bandwidth_limit,omitempty"`
	RstTtl               int64       `json:"rst_ttl,omitempty"`
	ReturnHdrs           []ReturnHdr `json:"return_hdrs,omitempty"`
}

// ReturnHdr represents a return header for HTTP request rules
type ReturnHdr struct {
	Name string `json:"name"`
	Fmt  string `json:"fmt"`
}
...
type HttpcheckPayload struct {
	...
	Headers         []CheckHdr `json:"headers,omitempty"`
...
// CheckHdr represents a header for HTTP check
type CheckHdr struct {
	Name string `json:"name"`
	Fmt  string `json:"fmt"`
}
...
type TcpCheckPayload struct {
	...
	ToutStatus      string `json:"tout_status"`
	VarExpr         string `json:"var_expr"`
	VarFmt          string `json:"var_fmt"`
